<template>
  <div v-show="state.visible" class="fixed inset-0 z-[10030] pointer-events-auto">
    ...
    <div class="relative h-full flex items-center justify-center">
      <div class="w-[22.5rem] h-[30rem] bg-[var(--color-main-bg)] rounded-[20px] overflow-hidden">
        ...
        <div class="w-[18.75rem] mx-auto -translate-y-[1.6rem]">
          ...
          <div class="h-[3.1875rem] rounded-[6px] border-[.0625rem] border-[var(--color-warning)] overflow-hidden mt-[.6rem]">
            <div 
            v-for="item in 10"
            >00:00-00:59</div>
          </div>
